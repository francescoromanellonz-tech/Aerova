...
/* Chassis centre — must match CHASSIS in ExplodedMachineSVG. */
const CHASSIS_CENTER = { x: 360, y: 640 };
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      moduleNodes.forEach((node, i) => {
        ...
        const partLen  = segment * 0.55;          // module fly-out
        const lineLen  = segment * 0.35;          // line draw, after part lands
        // Module: compressed -> exploded
        tl.to(node, {
        ...
        // Pull line: fade in + dashoffset 0 (draw it)
    ...
    >
      <div className="sticky top-0 h-screen flex items-stretch overflow-hidden">
        ...
        <div className="w-[58%] relative flex items-center justify-center px-6 xl:px-10">
          ...
          />
          <div className="relative z-10 w-full h-full max-h-[88vh] flex items-center justify-center">
